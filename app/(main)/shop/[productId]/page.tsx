...
// Komponen yang memerlukan akses DOM/Browser di-load secara dinamis
...
const RelatedProducts = dynamic(
  () => import("@/components/products/RelatedProducts"),
  {
    ssr: false,
    loading: () => (
      <div className="mt-8 w-full h-64 bg-gray-100 animate-pulse rounded-lg" />
    ),
  }
);
...
import type { ProductDetailed, Tables, ReviewDisplay } from "@/types";
  ...
  return (
    <div className="max-w-screen-xl mx-auto p-4 md:p-8 flex flex-col items-start gap-4 md:gap-6 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 w-full">
        {/* ProductGallery di-load secara dinamis */}
        <ProductGallery
          isInModal={false}

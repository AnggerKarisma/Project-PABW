  ...
  return (
    <div className="w-full shadow-md bg-gray-100 dark:bg-gray-700 p-4 md:p-6 rounded-lg">
      ...
      <div className="flex justify-between mb-4">
        ...
        <span className="text-gray-900 dark:text-white">Rp {formatPrice(getTotalPrice())}</span>
      </div>
      <div className="flex justify-between mb-4">
        <span className="text-gray-700 dark:text-gray-300">Ongkos Kirim:</span>
        <span className="text-gray-900 dark:text-white">Rp {formatPrice(getShippingFee())}</span>
      </div>
      <div className="flex justify-between mb-4">
        <span className="text-gray-700 dark:text-gray-300">Pajak:</span>
        <span className="text-gray-900 dark:text-white">Rp {formatPrice(getTax())}</span>
      </div>

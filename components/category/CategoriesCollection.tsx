...
const CategoriesCollection = () => {
  ...
  const collections = [
    { title: "Jam Tangan", data: watches },
    { title: "Headphone", data: headphones },
    { title: "Komputer", data: computers },
    { title: "Smartphone", data: smartphones },
  ];
          ...
          (collection) =>
            collection.data.length > 0 && (
              <div
                ...
                onClick={() =>
                  handleCollectionClick(collection.data[0].category)
                }
              ...
              >
                <h2 className="text-xl md:text-2xl text-center font-semibold my-4 w-full">
                  Penawaran Terbaik Untuk Kamu Di{" "}
                  <span className="text-2xl font-bold">
                    {collection.data[0].category}
                  </span>
                </h2>

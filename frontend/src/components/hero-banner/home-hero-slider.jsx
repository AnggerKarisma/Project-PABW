...
// internal
import slider_img_1 from "@assets/img/banner/pele.jpg";
import slider_img_2 from "@assets/img/banner/pele.png";
...
const HomeHeroSlider = () => {
  ...
  <Image
    src={item.img}
    alt="slider-img"
    className="w-100 max-w-sm h-auto mx-auto"
  />
</div>
                </div>
              </div>

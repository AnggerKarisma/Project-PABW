            ...
            <div className="row">
              <div className="col-xl-9 col-lg-8">
                <div className="tp-contact-wrapper">
                  <h3 className="tp-contact-title">Kirim Pesan-Pesan</h3>
                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p data-info="mail">
                        <a href="mailto:contact@shofy.com">contact@mahakamstore.com</a>
                      </p>
                      <p data-info="phone">
                        <a href="tel:670-413-90-762">+62 895 342503504</a>
                      </p>
                    </div>
                  </div>
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p>
                        <a
                          ...
                          target="_blank"
                        >
                          Karang Joang City <br /> Balikpapan
                        </a>
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="tp-contact-info-content">
                      <div className="tp-contact-social-wrapper mt-5">
                        <h4 className="tp-contact-social-title">
                          Temui kami di media sosial kami
                        </h4>
